...
const CHORD_FREQ = {
  ...
  'C7': [261.63, 329.63, 392.0, 523.25],
  'D7': [293.66, 369.99, 440.0, 587.33],
  'E7': [329.63, 415.3, 493.88, 587.33],
  'F7': [349.23, 440.0, 523.25, 659.26],
  'G7': [392.0, 493.88, 587.33, 698.46],
  // Major 7th chords
  'Cmaj7': [261.63, 329.63, 392.0, 493.88],
  'Dmaj7': [293.66, 369.99, 440.0, 554.37],
  'Emaj7': [329.63, 415.3, 493.88, 622.25],
  'Fmaj7': [349.23, 440.0, 523.25, 659.26],
  'Gmaj7': [392.0, 493.88, 587.33, 739.99],
  // Suspended chords
  'Csus2': [261.63, 293.66, 392.0],
  'Csus4': [261.63, 349.23, 392.0],
  'Dsus2': [293.66, 329.63, 440.0],
  'Dsus4': [293.66, 392.0, 440.0],
  'Esus2': [329.63, 369.99, 493.88],
  'Esus4': [329.63, 440.0, 493.88],
  'Fsus2': [349.23, 392.0, 523.25],
  'Fsus4': [349.23, 466.16, 523.25],
  'Gsus2': [392.0, 440.0, 587.33],
  'Gsus4': [392.0, 523.25, 587.33],
};
...
lyrics: [
  ...
  { id: 9, title: 'Hotel California',
    ...
    lyrics: [
      ...
      { text: "4-3-2-1-2-1, 3-2-1", chord: "Am", beats: 4 },
      { text: "4-3-2-1-2-1", chord: "E7", beats: 4 },
      { text: "4-3-2-1-2-1, 3-2-1", chord: "G", beats: 4 },
      { text: "4-3-2-1-2-1", chord: "D", beats: 4 },
      { text: "4-3-2-1-2-1, 3-2-1", chord: "F", beats: 4 },
      { text: "4-3-2-1-2-1", chord: "C", beats: 4 },
      { text: "4-3-2-1-2-1, 3-2-1", chord: "Dm", beats: 4 },
      { text: "4-3-2-1-2-1 (Let ring)", chord: "E7", beats: 8 },
